 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   ` ~  |   1! |   2@ |   3# |   4$ |   5% | LEFT |           | RIGHT|   6^ |   7& |   8* |   9( |   0) |   - _  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L2  |  `~  |AltShf| App  | LGui |                                       | RGui |  [{  |  ]}  |  -_  | RShift |
 *   `----------------------------------'                                       `------------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Esc  | Right|       | PgUp | PgDn |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        MO(MDIA),       KC_GRV,       LALT(KC_LSFT),  ALT_T(KC_APP),  KC_LGUI,
                                                      KC_LGUI,KC_LGUI,
                                                              KC_HOME,
        ...
        // right hand
             ...
             KC_RSFT,     KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_EQL,
                                  KC_RGUI,KC_LBRC,KC_RBRC,KC_MINS,          KC_RSFT,
             KC_PGUP,     KC_ESC,
             KC_QUOT,
             KC_RIGHT,    KC_TAB, KC_ENT
    ),
 ...
 * |        |      |      | MsUp |      | WhUp |      |           |      |      |      |  Up  |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |RESET   |      |MsLeft|MsDown|MsRght|WhDown|------|           |------|      | Left | Down | Right|      |  Play  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      | Lclk | Rclk |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |VolUp |VolDn | Mute |      |      |
